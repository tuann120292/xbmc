  ...
  { // movie/show/episode
    ...
    if (type == VIDEODB_CONTENT_TVSHOWS)
    {
      ...
      if ( m_movieItem->GetVideoInfoTag()->m_iEpisode > 0)
        m_movieItem->SetProperty("percentwatched", static_cast<int>(static_cast<double>(m_movieItem->GetVideoInfoTag()->m_playCount) / static_cast<double>(m_movieItem->GetVideoInfoTag()->m_iEpisode)*100));
      else
