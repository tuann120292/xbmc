...
void CGUITextLayout::ParseText(const std::wstring &text, uint32_t defaultStyle, color_t defaultColor, GUIResourceProviderPtr colorProvider, vecColors &colors, vecText &parsedText)
{
