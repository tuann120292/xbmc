...
CGUIFont* GUIFontManager::LoadTTF(const std::string& strFontName, const std::string& strFilename, color_t textColor, color_t shadowColor, const int iSize, const int iStyle, const RESOLUTION_INFO &sourceRes, bool border, float lineSpacing, float aspect, bool preserveAspect)
{
