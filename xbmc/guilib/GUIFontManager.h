...
public:
  ...
  CGUIFont* LoadTTF(const std::string& strFontName, const CStdString& strFilename, color_t textColor, color_t shadowColor, const int iSize, const int iStyle, const RESOLUTION_INFO &res, bool border = false, float lineSpacing = 1.0f, float aspect = 1.0f, bool preserveAspect = false);
